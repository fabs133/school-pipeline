...
def classify_section(
    ...
    candidates = [
        spec for spec in _REGISTRY if not (spec.never_first and is_first) and not (spec.never_last and is_last)
    ]
    ...
    scored = [(spec, _score_spec(spec, signals, structure_hint, style_mults)) for spec in candidates]
